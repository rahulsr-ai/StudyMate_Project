...
function LandingHero() {
  return (
    <section
      className="w-full overflow-hidden  flex flex-col items-center justify-center relative
      min-h-screen bg-gradient-to-br from-zinc-900 to-black 
 "
    >
      ...
      <div className="flex flex-col justify-center items-center w-[250px] sm:w-[300px] md:w-[500px] lg:w-[700px] z-50 pointer-events-auto min-h-screen">
        <motion.h1
